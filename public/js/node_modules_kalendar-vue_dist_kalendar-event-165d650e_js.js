"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_kalendar-vue_dist_kalendar-event-165d650e_js"],{
...
var script = {
  ...
  computed: {
    isPast: function isPast() {
      var now = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.g)(new Date().toISOString());
      return (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.f)(this.event.start.value, now);
    },
    ...
    information: function information() {
      var _this$event = this.event,
          ...
          key = _this$event.key;
      var payload = {
        start_time: (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.j)(start.value),
        end_time: (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.j)(end.value),
        kalendar_id: id,
        key: key,
        data: data
      };
