(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_kalendar-vue_dist_kalendar-weekview-7d89e606_js"],{
...
var script = {
  ...
  components: {
    kalendarCell: function kalendarCell() {
      return __webpack_require__.e(/*! import() */ "node_modules_kalendar-vue_dist_kalendar-cell-148179a7_js").then(__webpack_require__.bind(__webpack_require__, /*! ./kalendar-cell-148179a7.js */ "./node_modules/kalendar-vue/dist/kalendar-cell-148179a7.js"));
    }
  },
  ...
  computed: {
    isWeekend: function isWeekend$1() {
      return (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.i)(this.day.value);
    },
    isToday: function isToday$1() {
      return (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.a)(this.day.value);
    }
  },
  data: function data() {
    return {
  ...
  methods: {
    ...
    addEvent: function addEvent(payload) {
      ...
      var from = payload.from,
          to = payload.to;
      from = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.g)(from);
      to = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.g)(to);
      return myWorker.send("constructNewEvent", {
        event: (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.b)({}, payload, {
          from: from,
          to: to
        })
        ...
        events.push((0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.b)({}, payload, {
    ...
    getDayEvents: function getDayEvents(events) {
      ...
      var clonedEvents = events.map(function (event) {
        return (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.c)(event);
      });
    ...
    updateCreator: function updateCreator(payload) {
      this.creator = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.b)({}, this.validateSelection(payload), {
        status: "creating"
      });
    ...
    validateSelection: function validateSelection(event) {
      ...
      if (event.direction === "reverse" && original_starting_cell.index > current_cell.index) {
        return (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.b)({}, event, {
    ...
    initiatePopup: function initiatePopup() {
      ...
      this.creator = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.b)({}, this.creator, {
...
var __vue_component__ = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.d)({
...
var script$1 = {
  ...
  computed: {
    ...
    passedTime: function passedTime() {
      ...
      var time = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.g)(now);
  ...
  methods: {
    _isToday: function _isToday(day) {
      return (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.a)(day);
    },
    ...
    isDayBefore: function isDayBefore(day) {
      ...
      var formattedNow = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.g)(now.toISOString());
      return (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.f)(day, (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.h)(formattedNow));
    },
    ...
    addHelperMethods: function addHelperMethods() {
      ...
      this.$kalendar.addNewEvent = function (payload) {
        ...
        var from = payload.from,
            to = payload.to;
        if (from.slice(-4) === "000Z") payload.from = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.j)(from);
        if (to.slice(-4) === "000Z") payload.to = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.j)(to);
...
var __vue_component__$1 = (0,_index_cb588f9f_js__WEBPACK_IMPORTED_MODULE_0__.d)({
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__vue_component__$1);
